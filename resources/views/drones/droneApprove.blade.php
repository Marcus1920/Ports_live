            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="col-md-2 " style="margin-top:10px;">
                        <select name="rejectReason" id="rejectReason_id" class="form-control input-sm">
                            <option value="SelectReasons">select Reasons</option>
                            {{--<option>{{$selectDroneRejectReasons[0]}}</option>--}}
...
@section('footer')
    <script>
        $('#rejectReason_id').on('change',function(){
