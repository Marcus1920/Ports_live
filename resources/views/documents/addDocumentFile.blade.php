            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                   ...
                   @foreach($selectRoles1 as $key=>$value) 
                     @if($key>0)
                     <?php  if(@in_array($key,old('role'))){
                      $checked='checked';
                      }else{
                         $checked='';
                        } ?>
                         <input type="checkbox" name="role[]" id='responders' class="rolechk" value="{!! $key !!}" style="opacity:1 !important; position:relative;" <?php  echo $checked;?>> {!! $value !!}
                      @endif

                   @endforeach
                    @if ($errors->has('role'))
                   <p class="help-block red">*{{ $errors->first('role') }}</p> 
                   @endif
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    <button type="submit" id='submitUpdateDocumentForm1' type="button" class="btn btn-sm">Upload File </button>
