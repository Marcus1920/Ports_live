              ...
              {  
                ...
                { 
                    ...
                    $(data.folder_images).each(function(index,value){                              
                       ...
                       var src = check_extention(value.img_url);

                      images+=" <div class='col-md-3 list-images' id='images_"+value.id+"'><img src='"+src+"' class='folder-img' alt='"+value.notes+"'/><p>  <span>"+value.name+"</span>  <i class='fa fa-times pull-right delete' aria-hidden='true' data="+value.id+"></i> <a href='{!! url('/downloadsDoc/"+value.id + "')!!}'> <i class='fa fa-download' aria-hidden='true'></i></a>  </p> </div>";
                    });
